...
//public class redTruss1 extends LinearOpMode {
...
//            flippyKeep();
//        }
//        //end of camera code the rest is a template
//        runtime.reset();
//        while(opModeIsActive() && runtime.seconds() < 1.5){//spini tini
//            SpinL();
//
//            keepTheArmUp();
//            microClose();
...
//        c1.setPosition(0);
//    }
//    public void diagonalLeft(){//self explanatory
//        fL.setPower(.5);
//        fR.setPower(0.);
//        bL.setPower(0.0);
//        bR.setPower(.5);
